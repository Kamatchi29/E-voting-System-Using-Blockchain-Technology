...
let contractAddress = "0x7ba37cafbaec4ec7e1223117410f3983faf59a93";
let contractAbi = [
  {
    "inputs": [
      {
...
const getAllCandidates = async() => {
  if(WALLET_CONNECTED != 0) {
    ...
    var candidates = await contractInstance.getAllVoteOfCandidates();
 ...
 try {
  const result = await contractInstance.getAllVoteOfCandidates();
